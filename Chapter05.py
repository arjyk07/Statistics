...
# 이론 상의 분위점은 정규분포의 퍼센트포인트를 사용하면(이론 상의 누적확률에 대한 분위수값) 계산할 수 있다.
...
"""
    정규분포의 분위수(quartile) 구하기             # 참고 사이트 : https://m.blog.naver.com/pmw9440/221805677577
    ex) 어느 고등학교생의 전교생의 상위 5%의 수학점수는 얼마인지를 구하라는 문제를 가끔보게 됩니다. 
        이것을 수학적인 용어로 바꾸면 0.95 분위수를 구하라는 말이 됩니다. 
        만약 특정분포가 정규분포이다면 Python에서는 scipy 패키지의 norm.ppf() 함수를 이용해서 구할 수 있습니다.
